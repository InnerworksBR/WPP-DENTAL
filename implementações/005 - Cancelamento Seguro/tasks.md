...
- **Arquivos envolvidos:** `tests/test_cancel_safe.py`, `src/infrastructure/integrations/calendar_service.py`.
...
- **Arquivos envolvidos:** `tests/test_cancel_safe.py`, `src/interfaces/tools/calendar_tool.py`.
...
- **Arquivos envolvidos:** `tests/test_cancel_safe.py`, `src/interfaces/http/app.py`.
...
|---|---|---|---|---|
| T-001 | Preparação | — | Pequena | [x] 2026-06-15 |
| T-002 | Preparação | CO-04 | Pequena | [x] 2026-06-15 |
| T-003 | Implementação | CA-06 | Média | [x] 2026-06-15 |
| T-004 | Implementação | — (RNF-004) | Pequena | [x] 2026-06-15 |
| T-005 | Implementação | CA-01 | Média | [x] 2026-06-15 |
| T-006 | Implementação | CA-07 | Pequena | [x] 2026-06-15 |
| T-007 | Implementação | CO-04 | Média | [x] 2026-06-15 |
| T-008 | Implementação | WE-01 | Média | [x] 2026-06-15 |
| T-009 | Implementação | WE-01 | Pequena | [x] 2026-06-15 |
| T-010 | Testes | CA-06 | Média | [x] 2026-06-15 |
| T-011 | Testes | CA-01 / CA-07 | Média | [x] 2026-06-15 |
| T-012 | Testes | WE-01 / CO-04 | Média | [x] 2026-06-15 |
