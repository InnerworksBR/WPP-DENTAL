...
### [ ] T-001 — Mapear regras de disponibilidade e ponto de fonte única
...
### [ ] T-002 — Adicionar configuração de feriados
...
### [ ] T-003 — Aplicar mínimo de dias úteis na criação (fonte única) — WE-05/CA-02
...
### [ ] T-004 — Aplicar mínimo de dias úteis na busca por data específica — WE-05
...
### [ ] T-005 — Endurecer `_is_offered_slot` (fail-closed) — AG-03 + AG-08
...
### [ ] T-006 — Aceitar "Particular" em `_has_valid_direct_plan` — AG-04
...
### [ ] T-007 — Exigir contexto de hora em `resolve_selection` — CA-07
...
### [ ] T-008 — Resolver ano por data de referência (virada de ano) — CA-08
...
### [ ] T-009 — Considerar feriados na contagem de dias úteis — CA-03
...
### [ ] T-010 — Ignorar eventos `cancelled` — CA-10
...
### [ ] T-011 — Tratar datetime sem offset com segurança em DST — CA-09
...
### [ ] T-012 — Preservar estado de agenda no reset de contexto — WE-11
...
### [ ] T-013 — Branch determinístico para confirmação proativa órfã — CO-05
...
### [ ] T-014 — Suíte de testes de regressão das regras de agenda
...
- **Arquivos envolvidos:** `tests/` (unitários e integração) cobrindo `calendar_service.py`, `calendar_tool.py`, `appointment_offer_service.py`, `clean_agent_service.py`, `conversation_service.py`, `app.py`.
...
### [ ] T-015 — Atualizar documentação e checklist de configuração
...
- **Arquivos envolvidos:** `implementações/007 - Regras de Agenda e Disponibilidade/spec.md`, README/config docs do projeto.
...
|---|---|---|---|---|---|
| T-001 | Mapear regras e fonte única | Todos | Preparação | Pequena | [ ] |
| T-002 | Configuração de feriados | CA-03 | Preparação | Pequena | [ ] |
| T-003 | Mínimo de dias úteis na criação | WE-05/CA-02 | Implementação | Média | [ ] |
| T-004 | Mínimo de dias úteis na busca | WE-05 | Implementação | Pequena | [ ] |
| T-005 | `_is_offered_slot` fail-closed + weekday | AG-03, AG-08 | Implementação | Média | [ ] |
| T-006 | Aceitar Particular | AG-04 | Implementação | Média | [ ] |
| T-007 | Contexto de hora em resolve_selection | CA-07 | Implementação | Média | [ ] |
| T-008 | Ano por data de referência | CA-08 | Implementação | Média | [ ] |
| T-009 | Feriados na contagem de dias úteis | CA-03 | Implementação | Média | [ ] |
| T-010 | Ignorar eventos cancelled | CA-10 | Implementação | Pequena | [ ] |
| T-011 | DST em datetime sem offset | CA-09 | Implementação | Média | [ ] |
| T-012 | Preservar estado no reset | WE-11 | Implementação | Média | [ ] |
| T-013 | Branch confirmação proativa órfã | CO-05 | Implementação | Média | [ ] |
| T-014 | Testes de regressão | Todos | Testes | Grande | [ ] |
| T-015 | Documentação e config | CA-03 + geral | Documentação | Pequena | [ ] |

> Total: 15 tarefas. Cabeçalho de progresso considera as 14 tarefas funcionais principais (T-001..T-014); T-015 é encerramento documental.
